For construct a rerandomizable encryption scheme, we combine the previous CCA2 encryption scheme with the LHSPS signature. Then we achieve a computational unlinkable RCCA encryption scheme.
